...
local L = AceLocale:NewLocale("MeWantRevenge", "enUS", true)
...
MeWantRevenge is an addon that will alert you to the presence of nearby enemy players. These are some of the main features.
]]
L["MeWantRevengeDescription2"] = [[
...
Players that are added to the Ignore list will not be reported by MeWantRevenge. You can add and remove players to/from this list by using the button's drop down menu or by holding the Control key while clicking the button.
...
Options for when MeWantRevenge is Enabled or Disabled.
]] 
L["EnableMeWantRevenge"] = "Enable MeWantRevenge"
L["EnableMeWantRevengeDescription"] = "Enables or disables MeWantRevenge."
L["EnabledInBattlegrounds"] = "Enable MeWantRevenge in battlegrounds"
L["EnabledInBattlegroundsDescription"] = "Enables or disables MeWantRevenge when you are in a battleground."
L["EnabledInArenas"] = "Enable MeWantRevenge in arenas"
L["EnabledInArenasDescription"] = "Enables or disables MeWantRevenge when you are in an arena."
L["EnabledInWintergrasp"] = "Enable MeWantRevenge in world combat zones"
L["EnabledInWintergraspDescription"] = "Enables or disables MeWantRevenge when you are in world combat zones such as Lake Wintergrasp in Northrend."
L["DisableWhenPVPUnflagged"] = "Disable MeWantRevenge when not flagged for PVP"
L["DisableWhenPVPUnflaggedDescription"] = "Enables or disables MeWantRevenge depending on your PVP status."
L["DisabledInZones"] = "Disable MeWantRevenge while in these locations"
L["DisabledInZonesDescription"]	= "Select locations where MeWantRevenge will be disabled"
...
Options for the MeWantRevenge window and tooltips.
]]
L["ShowOnDetection"] = "Show MeWantRevenge when enemy players are detected"
L["ShowOnDetectionDescription"] = "Set this to display the MeWantRevenge window and the Nearby list if MeWantRevenge is hidden when enemy players are detected."
L["HideMeWantRevenge"] = "Hide MeWantRevenge when no enemy players are detected"
L["HideMeWantRevengeDescription"] = "Set this to hide MeWantRevenge when the Nearby list is displayed and it becomes empty. MeWantRevenge will not be hidden if you clear the list manually."
...
L["AlphaDescription"] = "Set the transparency of the MeWantRevenge window."
L["AlphaBG"] = "Transparency in BGs"
L["AlphaBGDescription"] = "Set the transparency of the MeWantRevenge window in battlegrounds."
L["LockMeWantRevenge"] = "Lock the MeWantRevenge window"
L["LockMeWantRevengeDescription"] = "Locks the MeWantRevenge window in place so it doesn't move."
L["ClampToScreen"] = "Clamp to Screen"
L["ClampToScreenDescription"] = "Controls whether the MeWantRevenge window can be dragged off screen."
L["InvertMeWantRevenge"] = "Invert the MeWantRevenge window"
L["InvertMeWantRevengeDescription"] = "Flips the MeWantRevenge window upside down."
L["Reload"] = "Reload UI"
L["ReloadDescription"] = "Required when changing the MeWantRevenge window."
L["ResizeMeWantRevenge"] = "Resize the MeWantRevenge window automatically"
L["ResizeMeWantRevengeDescription"] = "Set this to automatically resize the MeWantRevenge window as enemy players are added and removed."
L["ResizeMeWantRevengeLimit"] = "List Limit"
L["ResizeMeWantRevengeLimitDescription"] = "Limit the number of enemy players shown in the MeWantRevenge window."
L["DisplayTooltipNearMeWantRevengeWindow"] = "Display tooltip near the MeWantRevenge window"
L["DisplayTooltipNearMeWantRevengeWindowDescription"] = "Set this to display tooltips near the MeWantRevenge window."
...
L["SelectFontDescription"] = "Select a Font for the MeWantRevenge Window."
L["RowHeight"] = "Select the Row Height"
L["RowHeightDescription"] = "Select the Row Height for the MeWantRevenge window."
L["Texture"] = "Texture"
L["TextureDescription"] = "Select a texture for the MeWantRevenge Window"
...
L["DisplayOnMapDescription"] = "Display map icons for the location of other MeWantRevenge users in your party, raid and guild when they detect enemies."
...
Options on how MeWantRevenge maintains and gathers data.
]]
...
L["ShareData"] = "Share data with other MeWantRevenge addon users"
L["ShareDataDescription"] = "Set this to share the details of your enemy player encounters with other MeWantRevenge users in your party, raid and guild."
L["UseData"] = "Use data from other MeWantRevenge addon users"
L["UseDataDescription"] = "Set this to use the data collected by other MeWantRevenge users in your party, raid and guild."
...
L["MeWantRevengeSlashDescription"] = "These buttons execute the same functions as the ones in the slash command /MeWantRevenge"
L["Enable"] = "Enable"
L["EnableDescription"] = "Enables MeWantRevenge and shows the main window."
L["Show"] = "Show"
...
L["Config"] = "Config"
L["ConfigDescription"] = "Open the Interface Addons configuration window for MeWantRevenge."
L["KOS"] = "KOS"
...
-- Output Messages
L["VersionCheck"] = "|cffc41e3aWarning! The wrong version of MeWantRevenge is installed. Remove this version and install MeWantRevenge Classic."
L["MeWantRevengeEnabled"] = "|cff9933ffMeWantRevenge addon enabled."
L["MeWantRevengeDisabled"] = "|cff9933ffMeWantRevenge addon disabled. Type |cffffffff/MeWantRevenge show|cff9933ff to enable."
L["UpgradeAvailable"] = "|cff9933ffA new version of MeWantRevenge is available. It can be downloaded from:\n|cffffffffhttps://www.curseforge.com/wow/addons/MeWantRevenge-classic"
...
L["MeWantRevengeSignatureColored"] = "|cff9933ff[MeWantRevenge] "
...
L["PlayerDetected"] = "[MeWantRevenge] Player detected: "
L["KillOnSightDetected"] = "[MeWantRevenge] Kill On Sight player detected: "
L["Level"] = "Level"
...
L["DaysAgo"] = "days ago"
L["Close"] = "Close"
L["CloseDescription"] = "|cffffffffHides the MeWantRevenge window. By default will show again when the next enemy player is detected."
...
L["Clear"] = "Clear"
L["ClearDescription"] = "|cffffffffClears the list of players that have been detected. CTRL-Click will turn MeWantRevenge On/Off. Shift-Click will turn all sound On/Off."
...
MeWantRevenge_KOSReasonListLength = 6
MeWantRevenge_KOSReasonList = {
	[1] = {
...
StaticPopupDialogs["MeWantRevenge_SetKOSReasonOther"] = {
    ...
    OnAccept = function(self)
		...
		MeWantRevenge:SetKOSReason(self.playerName, "Enter your own reason...", reason)
	end,
};
