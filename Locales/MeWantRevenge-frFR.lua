local L = LibStub("AceLocale-3.0"):NewLocale("MeWantRevenge", "frFR")
...
MeWantRevenge est un addon qui vous avertit de la présence de joueurs ennemis à proximité. Ce sont quelques-unes des principales caractéristiques.
]]
...
Options lorsque MeWantRevenge est activé ou désactivé.
]] 
L["EnableMeWantRevenge"] = "Activer MeWantRevenge"
L["EnableMeWantRevengeDescription"] = "Active ou désactive MeWantRevenge."
L["EnabledInBattlegrounds"] = "Activer MeWantRevenge en champs de bataille"
L["EnabledInBattlegroundsDescription"] = "Active ou désactive MeWantRevenge lorsque vous êtes sur un champ de bataille."
L["EnabledInArenas"] = "Activer MeWantRevenge en arènes"
L["EnabledInArenasDescription"] = "Active ou désactive MeWantRevenge lorsque vous êtes dans une arène."
L["EnabledInWintergrasp"] = "Activer MeWantRevenge en zone de combat mondiale"
L["EnabledInWintergraspDescription"] = "Active ou désactive MeWantRevenge lorsque vous êtes dans des zones de combat mondial comme le Joug-d’Hiver en Northrend."
L["DisableWhenPVPUnflagged"] = "Désactiver MeWantRevenge lorsque le mode JcJ est désactiver"
L["DisableWhenPVPUnflaggedDescription"] = "Active ou désactive MeWantRevenge en fonction de votre statut JcJ."
L["DisabledInZones"] = "Désactivez MeWantRevenge lorsque vous vous trouvez dans ces emplacements"
L["DisabledInZonesDescription"]	= "Sélectionnez les emplacements où MeWantRevenge sera désactivé"
...
Options pour la fenêtre MeWantRevenge et les infobulles.
]]
L["ShowOnDetection"] = "Afficher MeWantRevenge lorsque des joueurs ennemis sont détectés"
L["ShowOnDetectionDescription"] = "Choisir cette option pour afficher la fenêtre MeWantRevenge et la liste des ennemis proches si MeWantRevenge est masqué lorsque des joueurs ennemis sont détectés."
L["HideMeWantRevenge"] = "Cacher MeWantRevenge quand aucun ennemi est détecté"
L["HideMeWantRevengeDescription"] = "Choisir cette option pour masquer MeWantRevenge lorsque la liste des ennemis proches s'affiche et qu'elle devient vide. MeWantRevenge ne sera pas caché si vous effacez la liste manuellement."
...
L["AlphaDescription"] = "Définissez la transparence de la fenêtre MeWantRevenge."
L["AlphaBG"] = "Transparence sur les champs de bataille"
L["AlphaBGDescription"] = "Définissez la transparence de la fenêtre MeWantRevenge sur les champs de bataille."
L["LockMeWantRevenge"] = "Verrouillez la fenêtre MeWantRevenge"
L["LockMeWantRevengeDescription"] = "Verrouille la fenêtre MeWantRevenge pour qu'elle ne bouge pas."
L["ClampToScreen"] = "Garder à l'écran"
L["ClampToScreenDescription"] = "Contrôle si la fenêtre MeWantRevenge peut être déplacée hors écran."
L["InvertMeWantRevenge"] = "Inverser la fenêtre MeWantRevenge"
L["InvertMeWantRevengeDescription"] = "Renverse la fenêtre MeWantRevenge"
L["Reload"] = "Reload UI"
L["ReloadDescription"] = "Requis lors du changement de la fenêtre MeWantRevenge."
L["ResizeMeWantRevenge"] = "Redimensionner la fenêtre MeWantRevenge automatiquement"
L["ResizeMeWantRevengeDescription"] = "Choisir cette option pour redimensionner automatiquement la fenêtre MeWantRevenge au fur et à mesure que les joueurs ennemis sont ajoutés et supprimés."
L["ResizeMeWantRevengeLimit"] = "Limite de liste"
L["ResizeMeWantRevengeLimitDescription"] = "Limite le nombre de joueurs ennemis affichés dans la fenêtre MeWantRevenge."
L["DisplayTooltipNearMeWantRevengeWindow"] = "Afficher la bulle d'aide près de la fenêtre MeWantRevenge"
L["DisplayTooltipNearMeWantRevengeWindowDescription"] = "Choisir cette option pour afficher des infobulles près de la fenêtre MeWantRevenge."
...
L["SelectFontDescription"] = "Sélectionnez une police pour la fenêtre MeWantRevenge."
...
L["DisplayOnMapDescription"] = "Affichez les icônes de la carte pour localiser les autres utilisateurs MeWantRevenge de votre groupe / raid / guilde lorsqu'ils détectent des ennemis."
...
Options sur la façon dont MeWantRevenge maintient et recueille les données.
]]
...
L["ShareData"] = "Partager des données avec d'autres utilisateurs de MeWantRevenge"
L["ShareDataDescription"] = "Choisissez cette option pour partager les détails de vos rencontres avec des joueurs ennemis avec d'autres utilisateurs MeWantRevenge de votre groupe, de votre raid et de votre guilde."
L["UseData"] = "Utiliser les données d'autres utilisateurs de MeWantRevenge"
L["UseDataDescription"] = "Choisir cette option pour utiliser les données collectées par d'autres utilisateurs de MeWantRevenge dans votre groupe, raid et guilde."
...
L["Enable"] = "Activer"
L["EnableDescription"] = "Active MeWantRevenge et affiche la fenêtre principale."
L["Show"] = "Afficher"
L["ShowDescription"] = "SAffichez la fenêtre MeWantRevenge."
L["Hide"] = "Cacher"
...
L["Config"] = "Config"
L["ConfigDescription"] = "Ouvre la fenêtre de configuration de MeWantRevenge"
L["KOS"] = "TAV"
...
L["MeWantRevengeDisabled"] = "|cff9933ffAddon MeWantRevenge désactivé. Taper |cffffffff/MeWantRevenge show|cff9933ff pour l'activer"
L["UpgradeAvailable"] = "|cff9933ffUne nouvelle version de MeWantRevenge est disponible. Elle peut être téléchargée à partir de:\n|cffffffffhttps://www.curseforge.com/wow/addons/MeWantRevenge-classic"
...
L["PlayerDetected"] = "[MeWantRevenge] Joueur détecté: "
L["KillOnSightDetected"] = "[MeWantRevenge] Joueur Tuer à vue détecté: "
L["Level"] = "Niveau"
...
L["Clear"] = "Effacer"
L["ClearDescription"] = "|cffffffffEfface la liste des joueurs qui ont été détectés. Control-Click activera ou désactivera MeWantRevenge. Shift-Click activera ou désactivera tous les sons."
...
StaticPopupDialogs["MeWantRevenge_SetKOSReasonOther"] = {
    ...
    OnAccept = function(self)
		...
		MeWantRevenge:SetKOSReason(self.playerName, "Saisir votre propre raison...", reason)
	end,
};
